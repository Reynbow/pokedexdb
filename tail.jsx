function DetailPanel({ selected, onClose, onSelectPokemon }) {
        ...
        <div className="detail-hero">
            ...
            <section className="about single-col">
              ...
              <div className="about-list">
                <div className="about-row">
                  ...
                  <div className="value">
                    {(details.types || [])
                      ...
                      .map((t) => (
                        <span key={t.type.name} className={`type-chip type-${t.type.name}`}>
                          {t.type.name}
                        </span>
                      ))}
                  </div>
                ...
                <div className="about-row">
                  ...
                  <span className="value">{(details.weight ?? 0) / 10} kg</span>
                </div>
              </div>
            </section>
          </div>
          <div className="hero-right">
            <div className="detail-title">
              <span className="dexno">#{String(id).padStart(4, "0")}</span>
              <h2>{name}</h2>
            </div>
            ...
            <div className="weak-resist">
              <div className="inline-block">
                <div className="inline-label">Weak To</div>
                <div className="types">
                  {weaknesses.length === 0 ? (
              ...
              <div className="inline-block">
                <div className="inline-label">Resists</div>
                <div className="types">
